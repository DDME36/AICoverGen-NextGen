        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['mangio-crepe', 'hybrid', 'fcpe', 'rmvpe'], value='mangio-crepe', label='Pitch detection algorithm', info='mangio-crepe: smoothest pitch (default) | hybrid[rmvpe+fcpe]: best quality (slower) | fcpe: smoother, less robotic | rmvpe: clear vocals')
            ...
            generate_btn.click(song_cover_pipeline,
                               inputs=[song_input, rvc_model, pitch, keep_files, is_webui, main_gain, backup_gain,
                                       ...
                                       output_format],
                               outputs=[ai_cover])
            clear_btn.click(lambda: [0, 0, 0, 0, 0.5, 3, 0.25, 0.33, 'mangio-crepe', 128, 0, 0.15, 0.2, 0.8, 0.7, 'mp3', None],
