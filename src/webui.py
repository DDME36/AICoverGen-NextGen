        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'fcpe', 'hybrid', 'mangio-crepe'], value='rmvpe', label='Pitch detection algorithm', info='rmvpe: clear vocals | fcpe: smoother, less robotic | hybrid: best quality (slower) | mangio-crepe: smoothest but slowest')
